...
/**
 * JwtTokenUtil Component will autodetect these classes for dependency injection
...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        return doGenerateToken(claims, userDetails.getUsername()); //get User name actually Contains User Email
    }
